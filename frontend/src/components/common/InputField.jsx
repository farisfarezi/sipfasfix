  ...
  return (
    <div className={`flex flex-col gap-1.5 ${className}`}>
      ...
      <input
        ...
        required={required}
        className={`w-full px-4 py-3 border rounded-soft focus:outline-none focus:ring-2 focus:ring-opacity-20 transition-all bg-background text-body-md text-text-main ${
          error
